...
create table Departamentos (
    ...
    descripcion text,
    estado_departamento tinyint(1) default 1,
...
create table Usuarios (
    ...
    constraint FK_usuario_login foreign key (id_login)
...
create table Categorias (
    ...
    constraint FK_categoria_departamento foreign key (id_departamento)
        references Departamentos(id_departamento) on delete cascade
);
...
create table Ubicaciones (
    ...
    nivel varchar(30),
    descripcion text,
    estado_ubicacion tinyint(1) default 1,
...
create table Prioridades (
    ...
    descripcion text,
    estado_prioridad tinyint(1) default 1,
...
create table Incidencias (
    ...
    constraint FK_incidencia_prioridad foreign key (id_prioridad)
        references Prioridades(id_prioridad) on delete cascade
);
...
create table Asignaciones (
    ...
    observaciones text,
    estado_asignacion tinyint(1) default 1,
...
create table HistorialIncidencias (
    ...
    constraint FK_historial_incidencia foreign key (id_incidencia)
        references Incidencias(id_incidencia) on delete cascade,
...
create table Adjuntos (
    ...
    constraint FK_adjunto_incidencia foreign key (id_incidencia)
        references Incidencias(id_incidencia) on delete cascade,
    constraint FK_adjunto_usuario foreign key (id_usuario)
        references Usuarios(id_usuario) on delete cascade
);